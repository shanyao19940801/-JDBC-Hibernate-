...
<form action="investpooladjustmanagefundaction!inquestInvestPool.action" id="inquestInvestPoolForm" method="post">
...
<jsp:include page="/includes/includefund.jsp"/>
...
<div class="pool-info-box">
    ...
    <div class="bd">
            <div class="pl10 pt10 pr10 pb10 zoom">
                ...
                <thead>
                <tr>
                    <th class="stk-table-th alignL" style="white-space:nowrap;">证券</th>
                ...
                <c:forEach items="${allAdjustCheckResults}" var="i" varStatus="s">
                        <tr class="stk-table-tr-odd">
                            <td class="stk-table-td alignL" style="text-align:center;">${i.sname}(${i.scode})</td>
...
<div class="stk-box-s2">
    <div class="stk-hd stk-ui-bar"><span class="stk-tit"><label><input type="checkbox" class="verMiddle">基金评级${updatetimestamp}</label></span></div>
    <div class="stk-bd zoom">
        <table class="stk-form-ui-st1">

            <tr  id="bondselecttr">
                <td class="hd" width="10%">基金评级</td><td class="bd">
                ${indicatorCodeMap.j0023}&nbsp;
            </td>
            </tr>
        </table>
    </div>
...
<script type="text/javascript">
    ...
    function ajaxSubmit() {
        ...
        $.ajax({
            url: "${contextPath}/investpool/investpooladjustmanagefundaction!inquestInvestPool.action",
            type: "post",
            dataType: "json",
            data: {
                "id": "${param.id}",
